...
async def main():
    context = {
        ...
        'meta_keywords': f'онлайн школа, эмоциональный интеллект, мягкие навыки, soft skills, авторский курс, '
                         f'Екатерина Тараканова, коучинг, наставничество, работа с убеждениями, реабилитация после '
                         f'бизнес-интенсивов',
        'meta_url': SITE_URL,
    }
...
async def study():
    ...
    context = {
        ...
        'meta_keywords': f'адаптивность, принципы, ценности, восприятие критики, постановка целей, выбор профессии, '
                         f'выученная беспомощность, тайм-менеджмент, колесо баланса, развитие психики, эффективная '
                         f'коммуникация, эмоции, эмоциональный интеллект, мягкие навыки, soft skills',
        'meta_url': SITE_URL,
    }
    if request.method == 'POST':
        user_name = request.form['user_name']
