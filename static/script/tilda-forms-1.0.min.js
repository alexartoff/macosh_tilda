...
window.scriptSysPayment = {}, window.handlerSysPayment = {}, window.isInitEventsZB = {},
window.isInitEventsCustomMask = {}, window.initForms = {}, window.tildaForm = {
    versionLib: "02.001",
    endpoint: "forms.tildacdn.com",
    isRecaptchaScriptInit: !1,
    currentFormProccessing: !1
}, window.tildaApiServiceRootDomain && 0 < window.tildaApiServiceRootDomain.indexOf(".") && (window.tildaForm.endpoint = "forms." + window.tildaApiServiceRootDomain),
t_onReady(function() {
    var t = document.getElementById("allrecords");
    !t || (r = t.getAttribute("data-tilda-project-lang")) && (window.t_forms__lang = r),
    t_forms__initForms();
    ...
    (e || t || r) && (o = "tilda-forms-payments-1.0", document.head.querySelector('script[src*="' + o + '"]') || ((a = document.createElement("script")).type = "text/javascript",
    a.src = "https://static.tildacdn.com/js/" + o + ".min.js", a.onerror = function() {
        console.error("Failed to load tilda-forms-payments: ", this.src);
    }, document.head.appendChild(a)));
    var o, a, r = window.t_forms__lang;
    "RU" !== r && "EN" !== r && (o = "tilda-forms-dict-1.0", document.head.querySelector('script[src*="' + o + '"]') || ((a = document.createElement("script")).type = "text/javascript",
    a.src = "https://static.tildacdn.com/js/" + o + ".min.js", a.onerror = function() {
    ...
    var t;
    !0 !== window.isInitEventsCustomMask && ((t = document.createElement("script")).type = "text/javascript",
    t.src = "https://static.tildacdn.com/js/tilda-forms-custommask-1.0.min.js", document.head.appendChild(t),
    t.onload = function() {
    ...
    for (var e, r, o = t.querySelectorAll(".js-tilda-rule"), a = [], n = !0, i = 0; i < o.length; i++) {
        var s = o[i], l = !!parseInt(s.getAttribute("data-tilda-req") || 0, 10), d = s.getAttribute("data-tilda-rule") || "none", c = "", u = "", m = s.getAttribute("data-tilda-rule-minlength") || 0, p = s.getAttribute("data-tilda-rule-maxlength") || 0, f = {}, _ = s.value, w = "", y = s.getAttribute("type"), h = s.getAttribute("name"), g = t.getAttribute("data-formcart");
        f.obj = s, f.type = [], _ && _.length && (w = _.replace(/[\s\u0000—\u001F\u2000-\u200F\uFEFF\u2028-\u202F\u205F-\u206F]/gi, ""),
        _ = _.trim()), 0 < _.length && (n = !1), m = m && parseInt(m, 10), p = p && parseInt(p, 10);
        var b = !_.length && !w.length, y = "checkbox" === y || "radio" === y, h = !t.querySelectorAll('[name="' + h + '"]:checked').length;
        if (l && (b || y && h)) f.type.push("req"); else {
            switch (d) {
              case "email":
              ...
              case "phone":
                ...
                v && (-1 !== v.indexOf("*") ? E += "a-zёа-я" : (-1 !== v.indexOf("a") && (E += "a-z"),
                -1 !== v.indexOf("а") && (E += "а-яё"))), E += "]+$", c = new RegExp(E, "gi"), (w.length && !w.match(c) || 1 == (u = w.replace(/[^0-9]+/g, "")).indexOf("000") || 1 == u.indexOf("111") && "9" != u.substring(0, 1) || 1 == u.indexOf("222") && "5" != u.substring(0, 1) || 1 == u.indexOf("333") || 1 == u.indexOf("444") || 1 == u.indexOf("555") && "0" != u.substring(0, 1) || 1 == u.indexOf("666") && "0" != u.substring(0, 1) || 1 == u.indexOf("8888") && "4" != u.substring(0, 1)) && f.type.push("phone");
                break;
    ...
    r = void 0 !== window.tcart_mincntorder && 0 < window.tcart_mincntorder, e && window.tcart.prodamount < window.tcart_minorder && ((f = {
        obj: {},
        type: []
    ...
    var e, r, o, a, n, i, s;
    "object" == typeof t && !t.length || (t instanceof Element || (t = t[0]), e = t.querySelectorAll(".js-errorbox-all"),
    r = t.querySelectorAll(".js-rule-error"), o = t.querySelectorAll(".js-error-rule-all"),
    a = t.querySelectorAll(".js-successbox"), n = t.querySelectorAll(".js-error-control-box"),
    i = t.querySelectorAll(".js-error-control-box .t-input-error"), s = document.getElementById("tilda-popup-for-error"),
    ...
    }), t_removeClass(t, "js-send-form-error"), t_removeClass(t, "js-send-form-success"),
    s && t_fadeOut(s));
    ...
    for (var u, m, p = 0; p < e.length; p++) if (e[p] && e[p].obj) {
        ...
        var f = e[p].obj;
        f instanceof Element || (f = f[0]), f && (n = f.closest(a)), n && (s = n.querySelectorAll(".t-input-error"),
        t_addClass(n, "js-error-control-box"), s.length && (i = !0));
        for (var _ = 0; _ < e[p].type.length; _++) {
            var w = e[p].type[_], y = t_forms__getMsg(w), l = "";
            (r = t.querySelector(".js-rule-error-" + w)) ? r.textContent && r.innerText || !y || -1 !== d.indexOf(y) ? (l = r.textContent || r.innerText,
            -1 === d.indexOf(y) && (d = d + '<p class="t-form__errorbox-item">' + l + "</p>")) : d = d + '<p class="t-form__errorbox-item">' + y + "</p>" : y && -1 === d.indexOf(y) && (d = d + '<p class="t-form__errorbox-item">' + y + "</p>"),
            i && (!l && t_forms__getMsg(w + "field") ? l = t_forms__getMsg(w + "field") : y && (l = y),
            l && n && (s = n.querySelectorAll(".t-input-error"), Array.prototype.forEach.call(s, function(t) {
    ...
    function h(t) {
        ...
        t_fadeOut(c), Array.prototype.forEach.call(t, function(t) {
            t.innerHTML = "", t_fadeOut(t);
        }), window.t_forms__errorTimerID && (window.clearTimeout(window.t_forms__errorTimerID),
        window.t_forms__errorTimerID = 0), window.isInitEventsZB[o] = !0);
    }
    return d && (c.querySelector(".t-form__errorbox-text").innerHTML = d, m = c.querySelectorAll(".t-form__errorbox-item"),
    Array.prototype.forEach.call(m, function(t) {
        t.style.display = "block";
    }), t_fadeIn(c)), window.t_forms__errorTimerID && window.clearTimeout(window.t_forms__errorTimerID),
    ...
    }, 1e4), window.isInitEventsZB[o] || (u = t.closest(".r"), m = "focus", document.addEventListener || (m = "focusin"),
    t_removeEventListener(u, m, h), t_addEventListener(u, m, h, !0), t_removeEventListener(u, "change", h),
    t_addEventListener(u, "change", h, !0)), t_triggerEvent(t, "tildaform:aftererror"),
    !0;
    ...
    for (var r = (r = t.getAttribute("data-inputbox")) || ".blockinput", o = "", a = !1, n = "", i = "", s = "", l = 0; l < e.length; l++) if (e[l] && e[l].obj) {
        ...
        var c = e[l].obj;
        c instanceof Element || (c = c[0]), c && (o = c.closest(r)), o && (i = o.querySelectorAll(".t-input-error"),
        t_addClass(o, "js-error-control-box"), 0 < i.length && (a = !0));
        for (d = 0; d < e[l].type.length; d++) {
            ...
            n[m].style.display = "block"; else if (t_forms__getMsg(u) && (n = t.querySelectorAll(".js-rule-error-all")).length) for (m = 0; m < n.length; m++) n[m].innerHTML = t_forms__getMsg(u),
            n[m].style.display = "block";
            a && (!s && t_forms__getMsg(u + "field") ? s = t_forms__getMsg(u + "field") : !s && t_forms__getMsg(u) && (s = t_forms__getMsg(u)),
            s && o && (i = o.querySelectorAll(".t-input-error"), Array.prototype.forEach.call(i, function(t) {
                t.innerHTML = s;
            })));
        }
    }
    ...
    document.body.insertAdjacentHTML("beforeend", e), window.removeEventListener("message", checkVerifyTildaCaptcha),
    ...
    try {
        ...
        window.tildaForm.tildamember.email = window.mauser.email, window.tildaForm.tildamember.code = window.mauser.code;
    } catch (t) {
    ...
    t && (t_removeClass(document.body, "t-body_success-popup-showed"), /iPhone|iPad|iPod/i.test(navigator.userAgent) && !window.MSStream && window.tildaForm.unlockBodyScroll(),
    t_fadeOut(t));
    ...
    t_addClass(e, "t-body_scroll-locked"), e.style.top = "-" + t + "px", e.setAttribute("data-popup-scrolltop", t));
}, window.tildaForm.unlockBodyScroll = function() {
    var t, e = document.body;
    t_hasClass(e, "t-body_scroll-locked") && (t = e.getAttribute("data-popup-scrolltop"),
    t_removeClass(e, "t-body_scroll-locked"), e.style.top = null, e.removeAttribute("data-popup-scrolltop"),
    document.documentElement.scrollTop = parseInt(t));
}, window.tildaForm.showSuccessPopup = function(t) {
    var e = "", r = document.getElementById("tildaformsuccesspopup"), o = document.getElementById("tildaformsuccesspopuptext"), a = document.body;
    ...
    r = document.getElementById("tildaformsuccesspopup"), o = document.getElementById("tildaformsuccesspopuptext"),
    e = r.querySelector(".t-form-success-popup__close-icon"), t_addEventListener(r, "click", function(t) {
    ...
    })), o.innerHTML = t, t_fadeIn(r), t_addClass(a, "t-body_success-popup-showed"),
    ...
    successBox && (dataSuccessMessage = successBox.getAttribute("data-success-message"),
    ...
    t_addClass(form, "js-send-form-success"), successCallback && 0 === successCallback.indexOf("window.") && (successCallback = successCallback.split(".")[1]),
    ...
    var upwidgetRemoveBtns = form.querySelectorAll(".t-upwidget-container__data_table_actions_remove svg"), inputText = form.querySelectorAll('input[type="text"]'), inputPhone = form.querySelectorAll('input[type="tel"], input[type="hidden"][data-tilda-rule="phone"]'), inputTextarea = form.querySelectorAll("textarea");
    ...
    var allRecords = document.getElementById("allrecords"), pageId = allRecords.getAttribute("data-tilda-page-id"), projectId = allRecords.getAttribute("data-tilda-project-id"), formId = form.getAttribute("id"), dataFormCart = form.getAttribute("data-formcart");
    ...
    2 === formType || !formType && formKey) {
        ...
        for (spec in tildaSpecs) {
            ...
            hiddenInput = form.querySelector('input[name="' + spec + '"]'), hiddenInput.value = tildaSpecs[spec]);
        }
        try {
            hiddenInput = form.querySelector("input[name=tildaspec-fp]"), hiddenInput || (form.insertAdjacentHTML("beforeend", '<input type="hidden" name="tildaspec-fp" value="">'),
            hiddenInput = form.querySelector("input[name=tildaspec-fp]")), window.tildastat ? hiddenInput.value = window.tildastat("fingerprint") : hiddenInput.value = "st" + window.pageYOffset + "w" + window.innerWidth + "h" + window.innerHeight + "ft" + form.getBoundingClientRect().top + window.pageYOffset;
        } catch (error) {}
        ...
        return xhr.open("POST", formUrl, !0), xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8"),
            ...
            if (4 === xhr.readyState) if (200 <= xhr.status && xhr.status < 400) {
                ...
                if (data) {
                    ...
                    if ("object" == typeof objData) {
                        ...
                        if (t_removeClass(btnSubmit, "t-btn_sending"), btnSubmit.tildaSendingStatus = "0",
                        objData && objData.error) {
                            ...
                            objData && objData.results && objData.results[0] ? (strValue = objData.results[0],
                            strValue = strValue.split(":"), formResult.tranId = strValue[0] + ":" + strValue[1],
                            formResult.orderId = strValue[2] || "0", formResult.orderId && "0" !== formResult.orderId && (window.tildaForm.orderIdForStat = formResult.orderId)) : (formResult.tranId = "0",
                            formResult.orderId = "0"), "undefined" != typeof jQuery && jQuery(form).data("tildaformresult", formResult),
                            form.tildaTranId = formResult.tranId, form.tildaOrderId = formResult.orderId;
                            var dataEventName = form.getAttribute("data-tilda-event-name") || "", dataEventName = dataEventName || ("y" === dataFormCart && objData && (objData.next && objData.next.type && ("function" !== objData.next.type || objData.next.value && ("stripev3" === objData.next.value.sysname || "outersite" === objData.next.value.installation)) || !objData.next) ? "/tilda/" + formId + "/payment/" : "/tilda/" + formId + "/submitted/"), title = "Send data from form " + formId, price = 0, product = "", priceEl = form.querySelector(".js-tilda-price");
                            if (window.Tilda && "function" == typeof window.Tilda.sendEventToStatistics) {
                                ...
                                0 < parseFloat(price) && (title = "Order " + formResult.orderId)) : priceEl && (price = priceEl.value,
                                0 < parseFloat(price) && (title = "Order " + formResult.orderId));
                                try {
                ...
                if (!xhr || 0 == xhr.status && tsDelta < 100) Array.prototype.forEach.call(allError, function(t) {
                    ...
                    window.tildaForm.send(form, btnSubmit, formType, formKey), !1;
    ...
    if ("y" !== form.getAttribute("data-is-formajax")) return -1 == form.getAttribute("action").indexOf(window.tildaForm.endpoint) && (t_removeClass(btnSubmit, "t-btn_sending"),
    btnSubmit.tildaSendingStatus = "3", form.submit(), !0);
    var dataForm = {};
    ...
    var xhr = new XMLHttpRequest();
    return xhr.open("POST", form.getAttribute("action"), !0), xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8"),
    xhr.setRequestHeader("Accept", "text/plain, */*; q=0.01"), xhr.onreadystatechange = function() {
        if (4 === xhr.readyState) if (200 <= xhr.status && xhr.status < 400) {
            var t = form.querySelector(".js-successbox"), e = form.getAttribute("data-success-url"), r = form.getAttribute("data-success-callback");
            if (t_removeClass(btnSubmit, "t-btn_sending"), btnSubmit.tildaSendingStatus = "0",
            l = xhr.responseText) if ("{" == l.substring(0, 1)) {
                var o = JSON.parse(l);
                if ("object" == typeof o) if (o && o.message && "OK" !== o.message) t.innerHTML = o.message; else if (o && o.error) {
                    var a = (s = t_forms__getErrorContainers(form, "Unknown error. Please, try again later.")).errorBoxes, n = s.allError;
...
try {
    ...
    if (-1 !== TILDAPAGE_URL.toLowerCase().indexOf("utm_") && (TILDAPAGE_URL = TILDAPAGE_URL.toLowerCase(),
    TILDAPAGE_QUERY = TILDAPAGE_URL.split("?"), TILDAPAGE_QUERY = TILDAPAGE_QUERY[1],
    "string" == typeof TILDAPAGE_QUERY)) {
        var arPair, i, arParams = TILDAPAGE_QUERY.split("&"), date;
        for (i in arParams) "function" != typeof arParams[i] && (arPair = arParams[i].split("="),
        "utm_" == arPair[0].substring(0, 4) && (TILDAPAGE_UTM = TILDAPAGE_UTM + arParams[i] + "|||"));
        0 < TILDAPAGE_UTM.length && (!window.tildastatcookie || "no" != window.tildastatcookie) && (date = new Date(),
...
function t_forms__initForms() {
    ...
    window.t_forms__inputData = {}, t_forms__addRecaptcha(), Array.prototype.forEach.call(t, function(t) {
        var e = t.id;
        window.initForms[e] || (t_forms__initEventPlaceholder(t), t_forms__addInputItsGood(t),
        t_forms__addAttrAction(t), t_forms__onSubmit(t), t_forms__onClick(t), t_forms__onRender(t),
        t_forms__addFocusOnTab(t), window.initForms[e] = !0);
    });
}

function t_forms__addFocusOnTab(t) {
    var e;
    window.isMobile || (t = t.querySelectorAll(".t-input, .t-select")) && (e = null,
    document.addEventListener("keydown", function() {
        ...
        t.addEventListener("focus", function() {
            "keyboard" === e && (t.classList.contains("t-input_pvis") && (t = t.parentElement),
            t.classList.add("t-focusable"), e = null);
...
function t_forms__initEventPlaceholder(t) {
    var e = "focus", r = "blur";
    document.addEventListener || (e = "focusin", r = "focusout"), t_removeEventListener(t, e, t_forms__removePlaceholder),
    t_addEventListener(t, e, t_forms__removePlaceholder, !0), t_removeEventListener(t, r, t_forms__addPlaceholder),
...
function t_forms__removePlaceholder(t) {
    ...
    "INPUT" === o.tagName && (r = o.closest("[data-input-lid]"), e = o.getAttribute("placeholder"),
    t = "", r ? t = r.getAttribute("data-input-lid") : (r = o.closest("form")) && (t = r.getAttribute("data-input-lid")),
...
function t_forms__onClick(t) {
    t_addEventListener(t, "dblclick", t_forms__initBtnDblClick), t_removeEventListener(t, "click", t_forms__initBtnClick),
...
//                if (t_addClass(r, "t-btn_sending"), r.tildaSendingStatus = "1", window.tildaForm.hideErrors(o),
//                e = window.tildaForm.validate(o), window.tildaForm.showErrors(o, e)) return t_removeClass(r, "t-btn_sending"),
...
//                    }), Array.prototype.forEach.call(i, function(t) {
//                        t.style.display = "block";
//                    }), t_addClass(o, "js-send-form-error"), t_removeClass(r, "t-btn_sending"), r.tildaSendingStatus = "0",
...
function t_forms__submitEvent(t) {
    var e, r = t;
    t.target && (r = t.target), r && (e = "", (r = r.querySelector('[type="submit"]')) && r.tildaSendingStatus && (e = r.tildaSendingStatus),
    e && "3" === e ? r.tildaSendingStatus = "" : (r && !t_hasClass(r, "t706__submit_disable") && r.click(),
    t.preventDefault ? t.preventDefault() : t.returnValue = !1));
}
...
function t_forms__getErrorContainers(t, e) {
    ...
    r = t.querySelectorAll(".js-errorbox-all")), o.length || (Array.prototype.forEach.call(r, function(t) {
...
function t_forms__addRecaptcha() {
    ...
    Array.prototype.forEach.call(t, function(t) {
        ...
        a ? (e = t.getAttribute("id"), window.tildaForm.isRecaptchaScriptInit || (r = document.head,
        o = document.createElement("script"), window.tildaForm.isRecaptchaScriptInit = !0,
        o.type = "text/javascript", o.src = "https://www.google.com/recaptcha/api.js?render=explicit",
        o.async = !0, r.appendChild(o), r.insertAdjacentHTML("beforeend", '<style type="text/css">.js-send-form-success .grecaptcha-badge {display: none;}</style>')),
        document.getElementById(e + "recaptcha") || t.insertAdjacentHTML("beforeend", '<div id="' + e + 'recaptcha" class="g-recaptcha" data-sitekey="' + a + '" data-callback="window.tildaForm.captchaCallback" data-size="invisible"></div>')) : t_removeClass(t, "js-tilda-captcha");
    });
}
...
function t_parseScripts(n, t) {
    ...
    Array.prototype.forEach.call(t, function(t) {
        ...
        t.innerHTML.length ? (r.appendChild(document.createTextNode(t.innerHTML)), t.parentNode.replaceChild(r, t)) : ((e = document.createElement("script")).src = t.attributes.src.value,
        n.appendChild(e), t_removeEl(t));
    });
}
...
function t_forms__onSuccess(t) {
    ...
    var c = "t" + r + "__inputsbox_hidden", u = [ 702, 708, 862, 945, 1014 ], m = !0, d = 960 < window.innerWidth ? l - 200 : l - 100, p = document.querySelector(".t-tildalabel");
...
function t_forms__scrollBeginForm(t) {
    var r = 400, o = (window.pageYOffset || document.documentElement.scrollTop) - (document.documentElement.clientTop || 0), a = t - o, n = 0, i = 16;
    document.body.setAttribute("data-scrollable", "true"), function t() {
        var e;
        n += i, window.scrollTo(0, (e = n, (e /= r / 2) < 1 ? a / 2 * e * e * e + o : a / 2 * ((e -= 2) * e * e + 2) + o)),
...
function t_fadeOut(t) {
    ...
    "none" !== t.style.display && (e = 1, r = setInterval(function() {
        t.style.opacity = e, (e -= .1) <= .1 && (clearInterval(r), t.style.display = "none",
...
function t_fadeIn(t) {
    var e, r;
    "block" !== t.style.display && (e = 0, t.style.opacity = e, t.style.display = "block",
...
function t_triggerEvent(t, e) {
    ...
    r.eventName = e, t.dispatchEvent ? t.dispatchEvent(r) : t.fireEvent ? t.fireEvent("on" + r.eventType, r) : t[e] ? t[e]() : t["on" + e] && t["on" + e]();
}